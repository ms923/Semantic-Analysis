...
def main():
    ...
    data_path = 'Semantic-Analysis\Streamlit\dataset.txt'
    ...
    analyzer.word2vec_model.save("models/word2vec_model")
    ...
    similarity_scores = np.array([  # Your similarity calculation logic here
    ...
    transformer_similarity = np.array([  # Your transformer similarity logic here
    ...
    additional_features = np.array([  # Your additional feature extraction logic here
        analyzer.extract_features(s1, s2) for s1, s2 in zip(preprocessed_sentences1, preprocessed_sentences2)
    ])
